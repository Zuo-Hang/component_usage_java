error id: file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java:org/springframework/kafka/config/ConcurrentKafkaListenerContainerFactory#
file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java
empty definition using pc, found symbol in pc: org/springframework/kafka/config/ConcurrentKafkaListenerContainerFactory#
...
import org.springframework.kafka.config.Concurrent@@KafkaListenerContainerFactory;
