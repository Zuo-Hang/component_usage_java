error id: file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java:_empty_/ConsumerConfig#
file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java
empty definition using pc, found symbol in pc: _empty_/ConsumerConfig#
