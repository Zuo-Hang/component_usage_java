error id: file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java:_empty_/ConsumerConfig#KEY_DESERIALIZER_CLASS_CONFIG#
file://<WORKSPACE>/mq-kafka-example/src/main/java/com/example/kafka/config/KafkaConfig.java
empty definition using pc, found symbol in pc: _empty_/ConsumerConfig#KEY_DESERIALIZER_CLASS_CONFIG#
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> manualAckConsumerFactory() {
        ...
        props.put(ConsumerConfig.KEY_@@DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        // 手动提交偏移量
