error id: file://<WORKSPACE>/mq-example/src/main/java/com/example/mq/consumer/DelayMessageConsumer.java:_empty_/RocketMQMessageListener#
file://<WORKSPACE>/mq-example/src/main/java/com/example/mq/consumer/DelayMessageConsumer.java
empty definition using pc, found symbol in pc: _empty_/RocketMQMessageListener#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 350
uri: file://<WORKSPACE>/mq-example/src/main/java/com/example/mq/consumer/DelayMessageConsumer.java
text:
```scala
