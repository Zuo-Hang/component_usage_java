error id: file://<WORKSPACE>/zookeeper-example/src/main/java/com/example/zookeeper/controller/ZooKeeperController.java:_empty_/CreateMode#
file://<WORKSPACE>/zookeeper-example/src/main/java/com/example/zookeeper/controller/ZooKeeperController.java
empty definition using pc, found symbol in pc: _empty_/CreateMode#
...
public class ZooKeeperController {
    ...
    public Map<String, Object> createPersistentNode(
        ...
        String createdPath = zooKeeperService.createNode(path, data, CreateM@@ode.PERSISTENT);
