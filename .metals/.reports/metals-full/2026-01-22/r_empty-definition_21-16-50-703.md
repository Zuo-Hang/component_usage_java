error id: file://<WORKSPACE>/zookeeper-example/src/main/java/com/example/zookeeper/util/ZooKeeperUtil.java:org/apache/curator/framework/recipes/cache/NodeCache#
file://<WORKSPACE>/zookeeper-example/src/main/java/com/example/zookeeper/util/ZooKeeperUtil.java
empty definition using pc, found symbol in pc: org/apache/curator/framework/recipes/cache/NodeCache#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 179
uri: file://<WORKSPACE>/zookeeper-example/src/main/java/com/example/zookeeper/util/ZooKeeperUtil.java
text:
```scala
...
import org.apache.curator.framework.recipes.cache.Node@@Cache;
